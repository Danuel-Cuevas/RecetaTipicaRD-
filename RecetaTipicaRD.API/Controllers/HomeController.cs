...
using RecetaTipicaRD.ViewModels.Home;


namespace RecetaTipicaRD.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, RecetaTipicaRDContext context)
        {
            _logger = logger;
            _context = context;
        }
